...
namespace kitronik_VIEW128x64 {
    ...
    //% weight=50
    //% subcategory=paint
    export function matrix16x24(i: string): Image {
        const im = <Image><any>i;
        return im
    }
    ...
    //% block="Bild24x16"
    //% imageLiteral=1
    //% imageLiteralColumns=24
    //% imageLiteralRows=16
    //% imageLiteralScale=0.01
    //% shim=images::createImage
    //% weight=50
    //% subcategory=paint
    export function matrix24x16(i: string): Image {
        const im = <Image><any>i;
        return im
    }
    ...
    //% weight=50
    //% subcategory=paint
    export function matrix24x24(i: string): Image {
        const im = <Image><any>i;
        return im
    }
     ...
     */
    //% block="write matrix with clear background %im|x %xpos|y %ypos"
    //% block.loc.de="schreibe Matrix %im|x %xpos|y %ypos"
    //% weight=65
    //% subcategory=paint
    export function writeImageNoBackOLED(im: Image, xpos: number, ypos: number) {
